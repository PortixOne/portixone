...
// Mock mode: zero setup, no runtime, no printer. Switch to a real print once
// the Portix Runtime is running
// (https://github.com/portixhq/portixone/tree/master/runtime) by replacing
// this with `new Portix({ appId: "print-ticket", tenant: "default" })` — see
